...
- Jan-24, 2026 - 11:15 PM +0800 - Merged 4.4 safety features: implemented character-based
  token truncation for context limits and regex-based secret redaction (API keys, private keys)
  for transcripts.
