...
7. [x] (3.1.1.7) Configurable chat list width (default 32 columns).
8. [x] (3.1.1.8) Horizontal scrolling for long chat titles.
...
7. [x] (3.1.2.7) Load chat list width from config into UI state.
8. [x] (3.1.2.8) Clamp and render chat list horizontal scroll offset.
...
5. [x] (3.1.3.5) Chat list width and horizontal scroll supported in base layout.
...
4. [x] (3.1.5.4) Add a runtime TUI render loop in the app crate to display the layout.

## 3.1.6 Logging

1. (3.1.6.1) Primary log file is `logs/app.log` (configured in
   `app/config/app.toml`).
2. (3.1.6.2) Error log file is `logs/app-error.log` (configured in
   `app/config/app.toml`).
