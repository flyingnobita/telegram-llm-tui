...
- [x] (2.1.7) Wire a runtime input loop in the app to dispatch key events,
  select keymaps from config, and trigger redraws.
- [x] (2.1.8) Add horizontal scroll controls for the chat list.
- [x] (2.1.9) Add a log window overlay with a hotkey toggle and scroll
  controls.
- [x] (2.1.10) Add horizontal scroll controls and scrollbars for the message pane.

### 2.2 Out of scope

- [ ] (2.2.1) Message virtualization or long-list performance tuning.
- [ ] (2.2.2) LLM export pipeline or transcript formatting.
- [ ] (2.2.3) Accessibility and theming (tracked in 3.3).
...
- [x] (2.3.9) Chats: Left/Right (VSCode) or h/l (vim) scrolls chat titles.
- [x] (2.3.10) Logs: `l` opens the log window overlay.
- [x] (2.3.11) Logs: Escape closes the log window overlay.
- [x] (2.3.12) Logs: Up/Down, PageUp/PageDown, or j/k (vim) scrolls log lines.
- [x] (2.3.13) Messages: Left/Right (VSCode) or h/l (vim) scrolls horizontally.
- [x] (2.3.14) Message pane renders vertical and horizontal scrollbars.
...
- [x] (2.4.4) Log view state stores open state, scroll offset, and page size.
- [x] (2.4.5) Message view state stores horizontal scroll offset and viewport width.
...
- [x] (3.1.7) Wire the app runtime loop to `ui::interaction` and config-driven
  keymap selection.
- [x] (3.1.8) Add chat list horizontal scroll handling to `ui::interaction`.
- [x] (3.1.9) Add log window state, rendering, and scroll handling.
- [x] (3.1.10) Add message pane scrollbars and horizontal scroll handling.
...
- [x] (4.1.5) Verify chat list horizontal scroll controls.
- [x] (4.1.6) Verify log window hotkey, escape close, and scroll behavior.
- [x] (4.1.7) Add a snapshot for the log window overlay.
- [x] (4.1.8) Verify message pane horizontal scroll controls.
...
- [x] (5.1.4) Add chat list horizontal scroll logic and tests.
- [x] (5.1.5) Implement log window overlay and input handling.
- [x] (5.1.6) Add message pane horizontal scroll logic and tests.
