...
- [x] (2.1.7) Provide a runtime TUI render loop in the app crate to display
  the layout.
...
- [x] (2.3.2) Main body is horizontal: chat list on the left, messages on the
  right.
- [x] (2.3.3) Chat list width is configurable (default 32 columns) with borders.
- [x] (2.3.4) Composer height is fixed (default 3 rows) with borders.
- [x] (2.3.5) Chat list supports horizontal scrolling for long titles.
...
- [x] (2.4.4) Chat list scroll offset applies to all rows and is adjustable via
  keyboard input.
...
- [x] (2.9.3) Chat list state tracks width and horizontal scroll offset.
...
- [x] (3.1.7) Wire an app runtime loop to render the layout via ratatui.
- [x] (3.1.8) Read chat list width from config and apply it to the layout.
- [x] (3.1.9) Support horizontal chat list scrolling with shared offset.
