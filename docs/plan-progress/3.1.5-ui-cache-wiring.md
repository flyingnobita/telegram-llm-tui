...
1. [x] (3.1.5.5.1) Replace fallback author labels with resolved display names.
2. [x] (3.1.5.5.2) Add paging and scrollback for large message lists (3.2).

## 3.1.5.6 Logging

1. (3.1.5.6.1) Primary log file is `logs/app.log` (configured in
   `app/config/app.toml`).
2. (3.1.5.6.2) Error log file is `logs/app-error.log` (configured in
   `app/config/app.toml`).
